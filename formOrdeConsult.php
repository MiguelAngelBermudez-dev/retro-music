...
<body>
<form action="" method="POST" name="formConsultaOrden">
    <input type="hidden" name="ConsultaOrden"/>
</form>
<?php 

if(isset($_POST['ConsultaOrden'])){
 $ConsultaOrden = $_POST['ConsultaOrden'];
...
$sql = "SELECT * FROM $tabla ORDER BY $ConsultaOrden";
