...
<body>
<form action="" method="POST" name="formLimit">
    <input type="hidden" name="ConsultaLimit"/>
</form>
<?php 
if(isset($_POST['ConsultaLimit'])){
$consultaLimit = $_POST['ConsultaLimit'];
...
$sql = "SELECT * FROM tb_mabc_dvds WHERE PrecioDVD > 25 LIMIT 5";
